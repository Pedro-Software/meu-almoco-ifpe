    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="flex-1 flex flex-col justify-center items-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <div className="space-y-4">
            ...
            <Link 
              href="/painel"
              className="flex w-full justify-center items-center rounded-xl text-sm font-semibold text-gray-500 hover:text-[#00913f] transition-colors py-2"
            >
              📺 Ver Painel do Refeitório
            </Link>
          </div>
        </div>
      </div>
      <footer className="py-6 mt-auto bg-gray-900 border-t border-gray-800 text-center">
        <p className="text-xs text-gray-500 font-medium px-4">
          Desenvolvido por: Pedro Borges e Pedro Victor.
        </p>
      </footer>
    </div>
  )
